                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            <span className="text-gray-600 dark:text-gray-400">Halo, {auth.user.name} (Owner)</span>
                            <Link
                                href={route('logout')}
                                method="post"
                                as="button"
                    ...
                    <div className="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-200 dark:border-gray-800">
                        <div className="p-8">
                            ...
                            <p className="mt-4 text-gray-600 dark:text-gray-400">
                                Anda berhasil masuk sebagai Owner! Selamat datang di StandUp-Sync. Di sini Anda bisa memantau progres tim Anda.
                            </p>
                        </div>
                    </div>
                </div>
