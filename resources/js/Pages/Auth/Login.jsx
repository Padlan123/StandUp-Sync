                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="password"
                                value={data.password}
                                className="block w-full px-4 py-3.5 bg-white border border-slate-200 rounded-lg text-[#0F172A] focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] transition-all outline-none"
